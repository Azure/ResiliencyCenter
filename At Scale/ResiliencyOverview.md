...
2. You'll see the following counts:
   ...
   - **Not evaluated service groups**: Service groups where one or more resources aren't supported by the Resiliency service and couldn't be evaluated. If there's a mixture of non-resilient and non-supported resources in the service group, the service group gets marked as non-resilient directly.
